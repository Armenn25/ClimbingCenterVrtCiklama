...
bih.addEventListener('click',()=>{
  if(bih){
    ...
    document.querySelector('.p3').innerHTML="Više"
    document.querySelector('.gallery_title').innerHTML="Galerija"
    document.querySelector('.contact-us_title').innerHTML="Kontakt"
    document.querySelector('.name_f').innerHTML="Ime"
    document.querySelector('.msg').innerHTML="Poruka"
...
eng.addEventListener('click',()=>{
  if(eng){
    ...
    document.querySelector('.p3').innerHTML="See more"
    document.querySelector('.gallery_title').innerHTML="Gallery"
    document.querySelector('.contact-us_title').innerHTML="Contact Us"
    document.querySelector('.name_f').innerHTML="Name"
    document.querySelector('.msg').innerHTML="Send Message"
